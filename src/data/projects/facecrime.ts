...
export const faceCrime: Project = {
  id: "facecrime",
  title: "FaceCrime",
  shortDescription: "A facial recognition tool that compares user faces against a database of 700,000+ sex offenders using cosine similarity.",
  description: "FaceCrime is a project built for the MongoDB x Voxel51 Hackathon that leverages advanced facial recognition technology. It allows users to either upload a facial image or capture one through their device camera, then employs cosine similarity with CLIP embeddings to search a database of over 700,000 sex offenders in the US. The system returns demographic information and links to government records for any potential matches.",
